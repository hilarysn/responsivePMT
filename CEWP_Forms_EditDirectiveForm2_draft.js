...
CKO.FORMS.DIRECTIVES.EditForm = function () {
    ...
    function FormLoaded(site) {
        v.site = site;
        resizeModalDialog();
        loadCSS(site + '/SiteAssets/css/CEWP_Forms_DirectiveForms.css'); //added gantt styles to .css
    ...
    // // stuff for phases section of form
    //<div class="row">
