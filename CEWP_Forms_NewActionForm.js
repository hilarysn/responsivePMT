...
CKO.FORMS.ACTIONS.NewForm = function () {
    ...
    function DataLoaded() {
        ...
        switch (v.action) {
            case "Copy":
                // Due to the Skill field being Managed Metadata, this code needs to use JSOM in lieu of REST
                ...
                urlString += "$select=Id,Title,ActionComments,Function,Enabler,EffortTypeValue,SupportAlignment,Customer,ParentID";
