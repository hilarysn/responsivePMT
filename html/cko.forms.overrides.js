...
CKO.FORMS.OVERRIDES = function () {
    ...
    function Init() {
        ...
        if (!v.template) {
            ...
            if (v.loc.indexOf("NewForm.aspx") > 0 || v.loc.indexOf("EditForm.aspx") > 0 || v.loc.indexOf("DispForm.aspx") > 0|| v.loc.indexOf("NewAction.aspx") > 0) {
                $(".ms-formtable").hide();
                $(".ms-toolbar").hide();
                $(".ms-formtoolbar").hide();
                overrideform();
    ...
    function overrideform() {
        ...
        $("div[data-field]").each(function (z) {
            ...
            $("td.ms-formbody").each(function (idx) {
                if (this.innerHTML.indexOf('FieldName="' + field + '"') != -1 || this.innerHTML.indexOf('fieldname="' + field + '"') != -1) {
