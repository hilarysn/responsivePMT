...
CKO.DASHBOARDS.ALLDASHBOARDS.SVD = function () {
    ...
    function start() {
        ...
        if (v.persontypefilter !== "All" || v.orgfilter !== "All" || v.timefilter !== "M") {
            v.totalhours = 0;
    ...
    function ActionsLoaded() {
        if (v.url === null) {
            ...
            urlString += "$select=Id,Expended,DateCompleted,EffortTypeValue,PersonTypeValue,OrganizationValue,Title&$orderby=Title";
            var today = new Date();                                                                                                                         //
        ...
        logit("SVD Chart Query urlString: " + urlString);
