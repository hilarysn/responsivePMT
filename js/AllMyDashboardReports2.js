...
CKO.DASHBOARDS.ALLDASHBOARDS = CKO.DASHBOARDS.ALLDASHBOARDS || {};
    ...
    CKO.DASHBOARDS.ALLDASHBOARDS.VARIABLES = {
        ...
        titles: ["My Authorities", "My Common Support", "My Competencies", "My Customers", "My Enablers", "My Functions", "My Standards", "My Skills", "My Standards vs Directives"],
        chart: null,
        firsttime: true,
        html: "",
        timefilter: null,
    ...
    function SelectFilters(obj) {
        ...
        switch (selected) {
            ...
            case "Authorities":
                $("#Authorities_panel");
                if (v.isdaterange) {
                    CKO.DASHBOARDS.ALLDASHBOARDS.Authorities().Init(v.site, id[1], v.timefilter, true, v.startdate, v.enddate);
                }
                else {
                    CKO.DASHBOARDS.ALLDASHBOARDS.Authorities().Init(v.site, id[1], v.timefilter, false, null, null);
                }
                break;
            ...
            case "Paragraph":
                $("#Paragraph_panel");
                if (v.isdaterange) {
                    CKO.DASHBOARDS.ALLDASHBOARDS.Paragraph2().Init(v.site, id[1], v.timefilter, true, v.startdate, v.enddate);
                }
                else {
                    CKO.DASHBOARDS.ALLDASHBOARDS.Paragraph2().Init(v.site, id[1], v.timefilter, false, null, null);
                }
                break;
            ...
            case "Competencies":
                $("#Competencies_panel");
                if (v.isdaterange) {
                    CKO.DASHBOARDS.ALLDASHBOARDS.Competencies().Init(v.site, id[1], v.timefilter, true, v.startdate, v.enddate);
                }
                else {
                    CKO.DASHBOARDS.ALLDASHBOARDS.Competencies().Init(v.site, id[1], v.timefilter, false, null, null);
                }
                break;
            ...
            case "Customers":
                $("#Customers_panel");
                if (v.isdaterange) {
                    CKO.DASHBOARDS.ALLDASHBOARDS.Customers().Init(v.site, id[1], v.timefilter, true, v.startdate, v.enddate);
                }
                else {
                    CKO.DASHBOARDS.ALLDASHBOARDS.Customers().Init(v.site, id[1], v.timefilter, false, null, null);
                }
                break;
            ...
            case "Enablers":
                $("#Enablers_panel");
                if (v.isdaterange) {
                    CKO.DASHBOARDS.ALLDASHBOARDS.Enablers().Init(v.site, id[1], v.timefilter, true, v.startdate, v.enddate);
                }
                else {
                    CKO.DASHBOARDS.ALLDASHBOARDS.Enablers().Init(v.site, id[1], v.timefilter, false, null, null);
                }
                break;
            ...
            case "Functions":
                $("#Functions_panel");
                if (v.isdaterange) {
                    CKO.DASHBOARDS.ALLDASHBOARDS.Functions().Init(v.site, id[1], v.timefilter, true, v.startdate, v.enddate);
                }
                else {
                    CKO.DASHBOARDS.ALLDASHBOARDS.Functions().Init(v.site, id[1], v.timefilter, false, null, null);
                }
                break;
            ...
            case "Parent":
                $("#Parent_panel");
                if (v.isdaterange) {
                    CKO.DASHBOARDS.ALLDASHBOARDS.Parent2().Init(v.site, id[1], v.timefilter, true, v.startdate, v.enddate);
                }
                else {
                    CKO.DASHBOARDS.ALLDASHBOARDS.Parent2().Init(v.site, id[1], v.timefilter, false, null, null);
                }
                break;
            ...
            case "Skills":
                $("#Skills_panel");
                if (v.isdaterange) {
                    CKO.DASHBOARDS.ALLDASHBOARDS.Skills().Init(v.site, id[1], v.timefilter, true, v.startdate, v.enddate);
                }
                else {
                    CKO.DASHBOARDS.ALLDASHBOARDS.Skills().Init(v.site, id[1], v.timefilter, false, null, null);
                }
                break;
            ...
            case "SVD":
                $("#SVD_panel");
                if (v.isdaterange) {
                    CKO.DASHBOARDS.ALLDASHBOARDS.SVD().Init(v.site, id[1], v.timefilter, true, v.startdate, v.enddate);
                }
                else {
                    CKO.DASHBOARDS.ALLDASHBOARDS.SVD().Init(v.site, id[1], v.timefilter, false, null, null);
                }
                break;
