    ...
    function GetSkills() {
        ...
        $.when(CKO.CSOM.GetListItems.getitemsfilteredcomplex("current", "DirectiveSkills", xml, inc)).then(function (items) {
            if (items.get_count() > 0) { //get map data
                ...
                GetBaselines(v.directiveid, v.totalexpendedhours,v.currenttotalhours);
                $("#btnAddBaseline").click(function (e) {
                    e.preventDefault();
                    var zurl = fixurl('/Lists/DirectiveSkillsBaselines/NewForm.aspx?DirectiveID=' + v.directiveid + '&Action=NewForm&IsDlg=1');
    ...
    function GetArchivedActions() {
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                ...
                logit("!!v.totalexpendedhours: " + v.totalexpendedhours + "archivedexpendedhours: " + archivedexpendedhours + "v.expendedhours : " + v.expendedhours);
