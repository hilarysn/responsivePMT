        ...
        $('#myactions').fullCalendar({
            eventSources: [{
                events: function (start, end, timezone, callback) {
                    ...
                    urlString += "$select=Id,Title,Expended,PMTUser/Id,ActionComments,Enabler,DateCompleted,EffortTypeValue,PhaseValue";
            ...
            eventClick: function (event) {
                ...
                dhtml += "<tr><td>ParentID</td><td>" + event.parentid + "</td></tr>";
                dhtml += "<tr><td>Type</td><td>" + event.Type + "</td></tr>";
                dhtml += "<tr><td>Phase</td><td>" + event.Phase + "</td></tr>"; 
                ...
                $(".btncopy").on("click", function (e) {
                    e.preventDefault();
                    var zurl = fixurl('/Lists/Actions/NewForm2.aspx?Action=Copy&CopyId=' + $(this).attr("data-actionid") + '&IsDlg=1');
                    CKODialog(zurl, 'New Action', '800', '820', 'NotificationCallback');
                });
                $(".btnedit").on("click", function (e) {
                    e.preventDefault();
                    var zurl = fixurl('/Lists/Actions/EditForm2.aspx?ID=' + $(this).attr("data-actionid") + '&IsDlg=1');
            ...
            viewRender: function (view) {
                ...
                $(".btnadd").on("click", function (e) {
                    e.preventDefault();
                    var zurl = fixurl('/Lists/Actions/NewForm2.aspx?Action=New&Date=' + $(this).attr("data-date") + '&IsDlg=1');
...
SP.SOD.notifyScriptLoadedAndExecuteWaitingJobs("CEWP_MyActions2.js");