...
CKO.FORMS.OVERRIDES = function () {
    ...
    function Init() {
        ...
        if (!v.template) {
            ...
            if (v.loc.indexOf("NewForm2.aspx") > 0 || v.loc.indexOf("EditForm2.aspx") > 0 || v.loc.indexOf("DispForm2.aspx") > 0) {
                $(".ms-formtable").hide();
                $(".ms-formtoolbar").hide();
                overrideform();
            }
    ...
    function overrideform() {
        ...
        $("div[data-field]").each(function (z) {
            ...
            var target = $(this);
            $("td.ms-formlabel").each(function (idx) {
                if (this.innerHTML.indexOf(field) !== -1) {
                    $(this).next(".ms-formbody").contents().appendTo(target);
                }
            });
        });
...
SP.SOD.notifyScriptLoadedAndExecuteWaitingJobs('cko.forms.overrides2.js');