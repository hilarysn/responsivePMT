    ...
    function (t) {
        ...
        o.prototype = {
            init: function (t) {
                ...
                var l = s(e, this);
                l.init(), this._renderHeaderResizers = l.doOnRender, this._mouseDelegates = i(8)(e), this._addLayers(this.$gantt), this._initEvents(), this.callEvent("onReady", [])
            },
            setSize: function (t, e) {
        ...
        window.gantt = i(22)(), i(103)(window.gantt)
    }, function (t, e, i) {
        function n() {
        ...
        t.exports = function () {
            var t = new n;
            i(23)(t), t.$services = t.$inject(i(24)), t.config = t.$inject(i(25)), t.ajax = i(26)(t), t.date = i(27)(t);
            var e = i(28)(t);
            ...
            var o = i(0);
            o.mixin(t, o), t.env = i(7);
            var l = i(10)();
            t.event = l.attach, t.eventRemove = l.detach, t._eventRemoveAll = l.detachAll, t._createDomEventScope = l.extend, o.mixin(t, i(31)(t));
            var d = i(32).init(t);
            ...
            }), t.mixin(t, d.layersApi), i(55)(t), t.$services.setService("layers", function () {
                return d.layersService
            }), i(56)(t), i(63)(t), i(66)(t), i(73)(t), i(74)(t), i(75)(t), i(76)(t), i(77)(t), i(78)(t), i(85)(t), i(86)(t), i(87)(t), i(88)(t), i(89)(t), i(90)(t), i(91)(t), i(92)(t), i(93)(t), i(94)(t), i(95)(t), i(96)(t), i(97)(t), i(98)(t), i(99)(t), i(100)(t), i(102)(t), t
        }
    }, function (t, e) {
        t.exports = function (t) {
            t.$inject = function (t) {
        ...
        function n(t) {
            ...
            i.registerView("cell", o), i.registerView("resizer", h), i.registerView("scrollbar", u), i.registerView("layout", l, function (t) {
                "main" === (t.$config ? t.$config.id : null) && e(t, x)
                    ...
                    return {
                        onCreated: function (e) {
                            e.$config = n.mixin(e.$config, {
                                bind: "task"
                            }), "grid" == e.$config.id && this.extendGantt(e), this._mouseDelegates = i(8)(t)
                        },
            ...
            o = function () {
                return function (t) {
                    ...
                    return {
                        onCreated: function (e) {
                            var s = e.$config;
                            s.bind = n.defined(s.bind) ? s.bind : "task", s.bindLinks = n.defined(s.bindLinks) ? s.bindLinks : "link", e._linksDnD = a.createLinkDND(), e._tasksDnD = r.createTaskDND(), e._tasksDnD.extend(e), "timeline" == e.$config.id && this.extendGantt(e), this._mouseDelegates = i(8)(t)
                        },
                        onInitialized: function (e) {
        ...
        var n = i(1),
            r = function (t, e) {
                ...
                w.attachEvent("onBeforeDragStart", e.bind(function (i, r) {
                    ...
                    if (c && (k = !n.locateClassName(r, "task_end_date"), c = !!f), v = f, p = c, m = k, c) {
                        var y = e.getTask(f),
                            ...
                            x = 0;
                        $ && (x = Math.floor($.offsetWidth / 2)), this._dir_end = s(y, !!m, x, b)
        ...
        t.exports = function (t) {
            for (var e = [i(67), i(68), i(69), i(70), i(71), i(72)], n = 0; n < e.length; n++) e[n] && e[n](t)
        }
    }, function (t, e, i) {
        var n = i(1);
        t.exports = function (t) {
        ...
        t.exports = function (t) {
            t.isUnscheduledTask = function (t) {
                ...
                var i, r, a, s = e.date,
                    ...
                    l = e.unit,
                    d = t.getScale();
                if (l == d.unit && o == d.step && +s >= +t._min_date && +s <= +t._max_date) a = Math.floor(t.columnIndexByDate(s)), t.getScale().trace_x[a] || (a -= 1, d.rtl && (a = 0)), r = new Date(t.getScale().trace_x[a]), i = t.date.add(r, o, l);
                else {
                    ...
                    for (var d = "", c = 0; c < n.length; c++) {
                        ...
                        switch (h) {
                            case "%Y":
                                ...
                                for (var v = f; v < p; v++) u += "<option value='" + v + "'>" + v + "</option>";
                                break;
                            case "%m":
                                e._time_format_order[1] = c, e._time_format_order.size++;
                                for (var v = 0; v < 12; v++) u += "<option value='" + v + "'>" + this.locale.date.month_full[v] + "</option>";
                                break;
                            case "%d":
                                e._time_format_order[0] = c, e._time_format_order.size++;
                                for (var v = 1; v < 32; v++) u += "<option value='" + v + "'>" + v + "</option>";
                                break;
                            case "%H:%i":
                                e._time_format_order[3] = c, e._time_format_order.size++;
                                var v = l,
                                    m = s.getDate();
                                for (e._time_values = []; v < o;) u += "<option value='" + v + "'>" + this.templates.time_picker(s) + "</option>", e._time_values.push(v), s.setTime(s.valueOf() + 60 * this._get_timepicker_step() * 1e3), v = 24 * (s.getDate() != m ? 1 : 0) * 60 + 60 * s.getHours() + s.getMinutes()
                        }
                        if (u) {
        ...
        t.exports = function (t) {
            var e = i(17);
            t.assert = i(101)(t), t.init = function (e, i, r) {
